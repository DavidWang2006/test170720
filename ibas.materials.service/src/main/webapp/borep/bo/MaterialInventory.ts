...
import {
    IMaterialInventory,
    BO_CODE_MATERIALINVENTORY,
} from "../../api/index";

/** 物料库存 */
export class MaterialInventory extends BOSimple<MaterialInventory> implements IMaterialInventory {
    ...
    /** 初始化数据 */
    protected init(): void {
        this.objectCode = MaterialInventory.BUSINESS_OBJECT_CODE;
    }
}
