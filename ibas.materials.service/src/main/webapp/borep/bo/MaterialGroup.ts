...
import {
    IMaterialGroup,
    BO_CODE_MATERIALGROUP,
} from "../../api/index";

/** 物料组 */
export class MaterialGroup extends BOMasterData<MaterialGroup> implements IMaterialGroup {
    ...
    get activated(): emYesNo {
        return this.getProperty<emYesNo>(MaterialGroup.PROPERTY_ACTIVATED_NAME);
    }
    /** 设置-激活 */
    ...
    /** 初始化数据 */
    protected init(): void {
        this.objectCode = MaterialGroup.BUSINESS_OBJECT_CODE;
    }
}
