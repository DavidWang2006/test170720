...
public class GoodsIssueLine extends BusinessObject<GoodsIssueLine> implements IGoodsIssueLine {

    /**
     * 序列化版本标记
     */
    private static final long serialVersionUID = 5343785245088797493L;
    ...
    * 数据库表
    */
    public static final String DB_TABLE_NAME = "CC_MM_IGE1";
