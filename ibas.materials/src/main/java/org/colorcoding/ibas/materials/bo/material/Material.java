...
public class Material extends BusinessObject<Material> implements IMaterial {
     ...
     * 序列化版本标记
     */
    private static final long serialVersionUID = 606357699965320191L;
    ...
    * 数据库表
    */
    public static final String DB_TABLE_NAME = "CC_MM_OITM";

    /**
    * 业务对象编码
    */
    public static final String BUSINESS_OBJECT_CODE = "CC_MM_MATERIAL";
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_FOREIGNNAME = registerProperty(PROPERTY_FOREIGNNAME_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_GROUP = registerProperty(PROPERTY_GROUP_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_BARCODE = registerProperty(PROPERTY_BARCODE_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<emItemType> PROPERTY_ITEMTYPE = registerProperty(PROPERTY_ITEMTYPE_NAME, emItemType.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<emYesNo> PROPERTY_PURCHASEITEM = registerProperty(PROPERTY_PURCHASEITEM_NAME, emYesNo.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<emYesNo> PROPERTY_SALESITEM = registerProperty(PROPERTY_SALESITEM_NAME, emYesNo.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<emYesNo> PROPERTY_INVENTORYITEM = registerProperty(PROPERTY_INVENTORYITEM_NAME, emYesNo.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<emYesNo> PROPERTY_PHANTOMITEM = registerProperty(PROPERTY_PHANTOMITEM_NAME, emYesNo.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<emYesNo> PROPERTY_FIXEDASSETS = registerProperty(PROPERTY_FIXEDASSETS_NAME, emYesNo.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_DEFAULTWAREHOUSE = registerProperty(PROPERTY_DEFAULTWAREHOUSE_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_PREFERREDVENDOR = registerProperty(PROPERTY_PREFERREDVENDOR_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Decimal> PROPERTY_AVGPRICE = registerProperty(PROPERTY_AVGPRICE_NAME, Decimal.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Decimal> PROPERTY_ONHAND = registerProperty(PROPERTY_ONHAND_NAME, Decimal.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Decimal> PROPERTY_ONCOMMITED = registerProperty(PROPERTY_ONCOMMITED_NAME, Decimal.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Decimal> PROPERTY_ONORDERED = registerProperty(PROPERTY_ONORDERED_NAME, Decimal.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Decimal> PROPERTY_MINIMUMINVENTORY = registerProperty(PROPERTY_MINIMUMINVENTORY_NAME, Decimal.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<DateTime> PROPERTY_VALIDDATE = registerProperty(PROPERTY_VALIDDATE_NAME, DateTime.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<DateTime> PROPERTY_INVALIDDATE = registerProperty(PROPERTY_INVALIDDATE_NAME, DateTime.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_PICTURE = registerProperty(PROPERTY_PICTURE_NAME, String.class, MY_CLASS);
