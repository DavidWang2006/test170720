...
public class GoodsReceiptLine extends BusinessObject<GoodsReceiptLine> implements IGoodsReceiptLine {

    /**
     * 序列化版本标记
     */
    private static final long serialVersionUID = -3303852486411237865L;
    ...
    * 数据库表
    */
    public static final String DB_TABLE_NAME = "CC_MM_IGN1";

    /**
    * 业务对象编码
    */
    public static final String BUSINESS_OBJECT_CODE = "CC_MM_GOODSRECEIPT";
