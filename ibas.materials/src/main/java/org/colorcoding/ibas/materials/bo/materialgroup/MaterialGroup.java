...
@XmlType(name = MaterialGroup.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@XmlRootElement(name = MaterialGroup.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@BOCode(MaterialGroup.BUSINESS_OBJECT_CODE)
public class MaterialGroup extends BusinessObject<MaterialGroup> implements IMaterialGroup {

    /**
     * 序列化版本标记
     */
    private static final long serialVersionUID = -9045751810453248238L;
    ...
    * 数据库表
    */
    public static final String DB_TABLE_NAME = "CC_MM_OITB";

    /**
    * 业务对象编码
    */
    public static final String BUSINESS_OBJECT_CODE = "CC_MM_MATERIALGROUP";
