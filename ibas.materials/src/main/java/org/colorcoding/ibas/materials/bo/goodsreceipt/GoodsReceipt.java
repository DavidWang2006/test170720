...
public class GoodsReceipt extends BusinessObject<GoodsReceipt> implements IGoodsReceipt {
     ...
     * 序列化版本标记
     */
    private static final long serialVersionUID = -7862498833248812867L;
    ...
    * 数据库表
    */
    public static final String DB_TABLE_NAME = "CC_MM_OIGN";
    ...
    * 
    */ 
    public static final IPropertyInfo<IGoodsReceiptLines> PROPERTY_GOODSRECEIPTLINES = registerProperty(PROPERTY_GOODSRECEIPTLINES_NAME, IGoodsReceiptLines.class, MY_CLASS);
    /**
    * 获取-库存收货-行集合
    * 
    * @return 值
