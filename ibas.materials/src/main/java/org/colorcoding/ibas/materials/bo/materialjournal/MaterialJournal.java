...
public class MaterialJournal extends BusinessObject<MaterialJournal> implements IMaterialJournal {
     ...
     * 序列化版本标记
     */
    private static final long serialVersionUID = 946352242413218957L;
    ...
    * 数据库表
    */
    public static final String DB_TABLE_NAME = "CC_MM_OINM";

    /**
    * 业务对象编码
    */
    public static final String BUSINESS_OBJECT_CODE = "CC_MM_MATERIALJOURNAL";
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_ITEMNAME = registerProperty(PROPERTY_ITEMNAME_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_BASETYPE = registerProperty(PROPERTY_BASETYPE_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Integer> PROPERTY_BASEENTRY = registerProperty(PROPERTY_BASEENTRY_NAME, Integer.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Integer> PROPERTY_BASELINNUM = registerProperty(PROPERTY_BASELINNUM_NAME, Integer.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<emDirection> PROPERTY_DIRECTION = registerProperty(PROPERTY_DIRECTION_NAME, emDirection.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_CURRENCY = registerProperty(PROPERTY_CURRENCY_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Decimal> PROPERTY_RATE = registerProperty(PROPERTY_RATE_NAME, Decimal.class, MY_CLASS);
