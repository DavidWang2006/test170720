...
public class InventoryTransfer extends BusinessObject<InventoryTransfer> implements IInventoryTransfer {
     ...
     * 序列化版本标记
     */
    private static final long serialVersionUID = -3241988407664174619L;

    /**
    * 当前类型
    */
    private static final Class<?> MY_CLASS = InventoryTransfer.class;

    /**
    * 数据库表
    */
    public static final String DB_TABLE_NAME = "CC_MM_OWTR";

    /**
    * 业务对象编码
    */
    public static final String BUSINESS_OBJECT_CODE = "CC_MM_INVENTORYTRANSFER";

    /**
    * 业务对象名称
    */
    public static final String BUSINESS_OBJECT_NAME = "InventoryTransfer";
    ...
    */
    ...
    public static final IPropertyInfo<Integer> PROPERTY_PRICELIST = registerProperty(PROPERTY_PRICELIST_NAME, Integer.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_PROJECT = registerProperty(PROPERTY_PROJECT_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_FROMWAREHOUSE = registerProperty(PROPERTY_FROMWAREHOUSE_NAME, String.class, MY_CLASS);
    ...
    * 属性名称-库存转储-行
    */
    private static final String PROPERTY_INVENTORYTRANSFERLINES_NAME = "InventoryTransferLines";

    /**
    * 库存转储-行的集合属性
    * 
    */ 
    public static final IPropertyInfo<IInventoryTransferLines> PROPERTY_INVENTORYTRANSFERLINES = registerProperty(PROPERTY_INVENTORYTRANSFERLINES_NAME, IInventoryTransferLines.class, MY_CLASS);
    /**
    * 获取-库存转储-行集合
    * 
    * @return 值
    */
    @XmlElementWrapper(name = PROPERTY_INVENTORYTRANSFERLINES_NAME)
    @XmlElement(name = InventoryTransferLine.BUSINESS_OBJECT_NAME, type = InventoryTransferLine.class)
    public final IInventoryTransferLines getInventoryTransferLines() {
        return this.getProperty(PROPERTY_INVENTORYTRANSFERLINES);
    }
    ...
    * @param value 值
    */
    public final void setInventoryTransferLines(IInventoryTransferLines value) {
        this.setProperty(PROPERTY_INVENTORYTRANSFERLINES, value);
    }
