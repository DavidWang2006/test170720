...
public class MaterialInventory extends BusinessObject<MaterialInventory> implements IMaterialInventory {
     ...
     * 序列化版本标记
     */
    private static final long serialVersionUID = -1351941278560749993L;
    ...
    * 数据库表
    */
    public static final String DB_TABLE_NAME = "CC_MM_OITW";

    /**
    * 业务对象编码
    */
    public static final String BUSINESS_OBJECT_CODE = "CC_MM_MATERIALINVENTORY";
