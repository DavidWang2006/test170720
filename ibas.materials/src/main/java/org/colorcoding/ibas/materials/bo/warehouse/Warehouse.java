...
@XmlType(name = Warehouse.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@XmlRootElement(name = Warehouse.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@BOCode(Warehouse.BUSINESS_OBJECT_CODE)
public class Warehouse extends BusinessObject<Warehouse> implements IWarehouse {

    /**
     * 序列化版本标记
     */
    private static final long serialVersionUID = -8789054585628346297L;
    ...
    * 数据库表
    */
    public static final String DB_TABLE_NAME = "CC_MM_OWHS";

    /**
    * 业务对象编码
    */
    public static final String BUSINESS_OBJECT_CODE = "CC_MM_WAREHOUSE";
